...
public class PiccodeScriptParser extends Parser {
	...
	public final StmtsContext stmts() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4972376024875020L) != 0)) {
					{
					{
					setState(70);
					stmt();
	...
	public final Func_argsContext func_args() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4976701056942092L) != 0)) {
				{
				setState(155);
				arg_list();
				}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 4:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4972303010430988L) != 0)) {
					{
					setState(186);
					expr(0);
					}
	...
	public final Do_exprContext do_expr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4972303010430988L) != 0)) {
				{
				{
				setState(408);
				expr(0);
