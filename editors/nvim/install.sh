...
if ! [[ -f "$NVIM_CONFIG_DIR/init.lua" ]]; then
  ...
  echo "please paste the following lua code into your configuratgion files in order to activate the pics package:"
...
echo "Picodescript NeoVim plugin successfully installed!"
